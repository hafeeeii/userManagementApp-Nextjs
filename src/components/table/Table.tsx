...
const Table = ({ userData }: { userData: UserData[] }) => {
  ...
  return (
    <div className="w-full h-screen md:h-fit flex flex-col  shadow-sm pb-4 rounded-lg ">
      ...
      <div className="scrollbar  overflow-x-auto  w-[95vw] md:w-[75vw] lg:w-[78vw] xl:w-full  ">
          ...
          <table className="leading-loose table-auto  ">
            ...
            <tbody className=" text-gray-700  ">
              {currentItems?.map((user, index) => (
                <tr
                  key={index}
                  className=" text-xs text-gray-600 font-semibold cursor-pointer hover:bg-blue-50"
